...
var demographics1 = {
    ...
    questions:[
        ...
        {prompt: '<p style="text-align:center; font-size:24px"><br>What is your email address?', required: true}
]};
...
var questions2 = [
    ...
    {prompt: '<p style="text-align:center; font-size:24px">How many hours of music do you listen to per week (estimate)?'},
];
...
// questions for EMA study 

var demographics4 = {
    type: 'survey-text',
    questions:[
        {prompt: '<p style="text-align:center; font-size:24px">What kind of exercise do you do? '},
        {prompt: '<p style="text-align:center; font-size:24px">Do you have gym access? (Yes/No) '},
        {prompt: '<p style="text-align:center; font-size:24px">How do you usually listen to music? (e.g. if listening to music in your phone, indicate the name of the app or website)'},
]};
...
var demographics3 = {
    ...
    questions: [
        ...
        {prompt: '<p style="text-align:center; font-size:24px">Are you currently employed? (paid/volunteer/unpaid) ',
        name: 'Employment',
        placeholder: ' ',
        options: [
...
var demographics_block = {
	timeline: [prompt, demographics1, demographics2, demographics3, conditionalBlock, demographics4],
